...
public class CaptureActivity extends Activity implements Callback {
    ...
    /**
     * The constant SCAN_CODE_RESULT.
     */
    public static final int SCAN_CODE_RESULT = 800;
