...
public class CardBelowFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initData() {
        ...
        ServeManager.getClassify(context, MyApplication.mUser == null ? "" : MyApplication.mUser.getUid() + "", "7", page + "", "", "", "","").enqueue(new Callback<ClassifyModel>() {
            @Override
...
//                }
    ...
    protected int setLayoutResouceId() {
        return R.layout.fragment_cardbelow;
    }
