...
public class FoldFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initView() {
        page = 1;
        classifyadapter = new ClassifyAdapter(context,1);
    ...
    protected void initData() {
        ...
        ServeManager.getClassify(context, MyApplication.mUser == null ? "" : MyApplication.mUser.getUid() + "", "8", page + "", "", "", "","").enqueue(new Callback<ClassifyModel>() {
            @Override
