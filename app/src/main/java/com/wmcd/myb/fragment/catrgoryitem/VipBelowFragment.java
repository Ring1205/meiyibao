...
public class VipBelowFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initData() {
        ...
        ServeManager.getClassify(context, MyApplication.mUser == null ? "" : MyApplication.mUser.getUid() + "", "13", page + "", "", "", "","").enqueue(new Callback<ClassifyModel>() {
            @Override
...
//                }
    ...
    protected int setLayoutResouceId() {
        return R.layout.fragment_vipbelow;
    }
