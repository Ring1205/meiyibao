...
public class VipFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initData() {
        ...
        ServeManager.getClassify(context, MyApplication.mUser == null ? "" : MyApplication.mUser.getUid() + "", "16", page + "", "", "", "","").enqueue(new Callback<ClassifyModel>() {
            @Override
