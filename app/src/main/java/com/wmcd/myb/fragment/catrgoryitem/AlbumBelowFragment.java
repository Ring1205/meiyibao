...
public class AlbumBelowFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initData() {
        ...
        ServeManager.getClassify(context, MyApplication.mUser == null ? "" : MyApplication.mUser.getUid() + "", "5", page + "", "", "", "","").enqueue(new Callback<ClassifyModel>() {
            @Override
